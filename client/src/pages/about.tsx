  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  We serve the Greater Toronto Area with premium roof cargo boxes and bike carriers from trusted brands 
                  like Thule, Yakima, and Kuat. Whether you're heading to Muskoka, Algonquin Park, or anywhere in Ontario, 
              ...
              <div className="bg-primary/10 rounded-lg p-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Convenient pickup and delivery throughout the GTA</span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Competitive rates and flexible rental periods</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="py-20 bg-primary/5">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold text-foreground mb-6">Where We Serve</h2>
            <div className="flex items-center justify-center gap-2 mb-6">
              <MapPin className="h-5 w-5 text-primary" />
              <span className="text-lg text-muted-foreground">Proudly serving the Greater Toronto Area</span>
            </div>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              We provide convenient pickup and delivery services throughout the GTA. 
              Premium gear ready for your next adventure.
            </p>
